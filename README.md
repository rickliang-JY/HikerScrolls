...
4. **Writing** — Add descriptions and blog text to each stop
...
| **Smart Place Naming** | Coordinates are automatically resolved to human-readable place names via Nominatim |
...
In **Settings → HikerScrolls Settings**:
